...
public class Tc_Service_BuyFor extends BaseClass {

	@Test
	public void Service_BuyFor1() throws InterruptedException {
		test = extent.createTest("Service_BuyFor");

		Service_BuyFor BuyFor = new Service_BuyFor(driver);
		...
		Utility.waitTillPageload(BuyFor.load);
		...
		Utility.SelectValue(BuyFor.ClickOnDepartment, BuyFor.DepartmentSlectdropdown, "Service");
		Thread.sleep(2000);
...
//Disclaimer	
		...
		Utility.Clickaction(BuyFor.AddVariablesBuyforAmount);
