...
import com.AutosigmaFixedOpts.PageObject.PartAccessories_OffMSRP;
...
public class Tc_PartAccessories_OffMSRP extends BaseClass {

	@Test
	public void PartAccessories_OffMSRP1() throws InterruptedException {
		test = extent.createTest("PartAccessories_OffMSRP");

		PartAccessories_OffMSRP OffMSRP = new PartAccessories_OffMSRP(driver);
		...
		Utility.SelectValue(OffMSRP.ClickOnDepartment, OffMSRP.DepartmentSlectdropdown, "Parts & Accessories");
...
//Disclaimer	
		...
		Utility.JavascriptExecutorClick(OffMSRP.AddVariables);
		test.info("Click On AddVariablesPercentAmount");
...
//SCHEDULEDCHANGE	
		...
		test.info("Click On ScheduledChangesSave");
		Utility.Clickaction(OffMSRP.OffMSRPScheduledChangesclose);

//VIEWCHANGELOG		

		test.info("Click On OffMSRPViewChangeLog");
		Utility.JavascriptExecutorClick(OffMSRP.ViewChangeLog);

		test.info("Click On OffMSRPViewChangeLogRestore");
