...
public class Service_BuyFor {

	public WebDriver driver;

	public Service_BuyFor(WebDriver driver) {
		this.driver = driver;
...
//ACTIVEOFFER
	...
	@FindBy(xpath = "//div[@id='buy-for_PA_Fixed_otps']")
...
//STARTDATE
	...
	@FindBy(xpath = "//button[@id='buy-for-calandericon']")
...
//IMAGEUPLOAD
	...
	@FindBy(xpath = "//div[@id='buy-for_service_Add_imge']")
...
//Disclaimer
	...
	@FindBy(xpath = "//button[@id='add-var-btn']")
	...
	public WebElement AddVariablesBuyforAmount;
...
//
	...
	@FindBy(xpath = "//button[@class='bg-primary capitalize text-white tracking-normal font-semibold v-btn v-btn--has-bg theme--light elevation-0 v-size--default']//span[normalize-space()='Apply']")
