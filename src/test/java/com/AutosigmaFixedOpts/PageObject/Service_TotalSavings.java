...
public class Service_TotalSavings {
	public WebDriver driver;

	public Service_TotalSavings(WebDriver driver) {
		this.driver = driver;
...
//ADDING THE SERVICE
	...
	@FindBy(xpath = "//span[@id='Add_service_btn']")
	public WebElement ClickOnAddService;

	@FindBy(xpath = "//input[@id='service_Dropdown']") // NAME OF THE SERVICE
	public WebElement ClickOnSelectService;

	@FindBy(xpath = "//div[@role='listbox']//div[@role='option']") // SLECTING THE NAME OF THE SERVICE
	public List<WebElement> SelectServiceDropdown;

	@FindBy(xpath = "(//*[contains(text(),'Add Service')])[2]")
...
//IMAGEUPLOAD
	...
	@FindBy(xpath = "//div[@id='total-savings_service_Add_imge']")
...
//Disclaimer
	...
	@FindBy(xpath = "//*[text()='Add Variables']")
...
//SCHEDULEDCHANGE
	...
	@FindBy(xpath = "(//button[@id='total-savings-scheduledChanges']//*[contains(text(),'Scheduled Changes')])[2]")
	...
	@FindBy(xpath = "//div[@class='flex items-center']//div//button[@type='button']")
...
//VIEWCHANGELOG
	...
	public void Allmodel(String allmodel) {
		for (WebElement listofmodel : SelectServiceDropdown) {
