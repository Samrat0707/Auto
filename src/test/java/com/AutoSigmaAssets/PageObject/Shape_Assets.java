...
public class Shape_Assets {

	public WebDriver driver;

	public Shape_Assets(WebDriver driver) {
		this.driver = driver;
...
// Verification
	...
	@FindBy(css = ".v-data-table__wrapper>table>tbody>tr>td:nth-child(1)")
	...
	public void ListText() {
		...
		for (WebElement namesmanufacturer : ListAssetName) {
